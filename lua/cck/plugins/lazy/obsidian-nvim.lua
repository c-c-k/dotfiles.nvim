...
-- repo url: <https://github.com/epwalsh/obsidian.nvim>
-- nvim help: `:help obsidian`
...
return {
  ...
  -- Obsidian.nvim is disabled because it does not currently feel convenient for my note taking workflow.
  enabled = false,
  opts = {
  ...
  config = function(_, opts)      
    ...
    require("obsidian").setup({
      ...
      workspaces = {
        {
          name = "testws",
          path = vim.fn.expand("$NOTEBOOKS_TEST_NB_ROOT/obsidian-nvim"),
      ...
      note_id_func = function(title)
        ...
        if title ~= nil then
          ...
          suffix = title:gsub("[^A-Za-z0-9_]", "_"):gsub("_+", "_"):lower()
        else
      ...
      -- If you don't want to set any mappings this way then set finder_mappings = {}
