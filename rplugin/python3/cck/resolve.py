...
from cck.notebook import get_current_notebook
from cck.globals import config
from cck.path import resolve_path_with_context
from cck.path import validate_path
...
def resolve_uri_as_path(
    ...
    # uri_resolvers = vim.vars.get("cck_uri_resolvers", [])
