...
def _get_ref_trg_start(nb_buffer: NBBuffer) -> int:
    buffer = nb_buffer.buffer
    try:
...
# def _add_ref_trg(nb_buffer: NBBuffer, description: str, target: str):
# def _add_ref_trg(buffer: Buffer, description: str, target: str):
def _add_ref_trg(vim: pynvim.Nvim, description: str, target: str):
    # buffer = nb_buffer.buffer
...
# def add_ref_link(nb_buffer: NBBuffer, description: str, target: str):
def add_ref_link(vim: pynvim.Nvim, description: str, target: str):
    cleaned_description = _clean_description(description)
    ref_trg_index = _add_ref_trg(vim, cleaned_description, target)
    _add_ref_src(vim, cleaned_description, ref_trg_index)
