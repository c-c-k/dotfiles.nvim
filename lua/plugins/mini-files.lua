        ...
        setminifilesmappings = {
          {
            ...
            callback = function(args)
              ...
              map("n", "<LEADER>upg", function()
                files_set_cwd("g")
              end, { desc = "Set PWD (global) to current dir" })
              map("n", "<LEADER>upt", function()
                files_set_cwd("t")
              end, { desc = "Set PWD (tab) to current dir" })
              map("n", "<LEADER>upl", function()
                files_set_cwd("l")
              end, { desc = "Set PWD (local) to current dir" })
              map("n", "<LEADER>upp", function()
                files_set_cwd()
              end, { desc = "Set PWD (auto) to current dir" })
